...
# url = "https://www.trademe.co.nz/a/property/residential/sale/wellington/wellington/khandallah"
# driver.get(url)
# time.sleep(5)
...
#     navurl = "https://www.trademe.co.nz/a/property/residential/sale/wellington/wellington/khandallah" + navlinks
#     driver.get(navurl)
#     time.sleep(5)
#     html_content = driver.page_source
#     soup = BeautifulSoup(html_content, "html.parser")
...
#     cursor = db.cursor()
#     query = "SELECT * FROM propertylist_khandallah WHERE addr = %s AND suburb = %s AND region = %s AND city = %s"
...
#         cursor = db.cursor()
#         query = "INSERT INTO propertylist_khandallah SET addr = %s, suburb = %s, region = %s, city = %s, price = %s, active = 1"
...
#         cursor = db.cursor()
#         query = "INSERT INTO active_listings_khandallah SET propid = %s, price = %s, link = %s, lastscan = %s"
...
#             cursor = db.cursor()
#             query = "UPDATE propertylist_khandallah SET active = 1 WHERE id = %s"
...
#         cursor = db.cursor()
#         query = "SELECT * FROM active_listings_khandallah WHERE propid = %s"
#         val = (propertyrecord[0][0],)
#         cursor.execute(query, val)
...
#                 cursor = db.cursor()
#                 query = "UPDATE active_listings_khandallah SET lastscan = %s WHERE id = %s"
...
#                 cursor = db.cursor()
#                 query = "INSERT INTO prior_listings_khandallah SET propid = %s, price = %s, link = %s, timeadded = %s"
#                 val = (activerecord[0][1], price, link, currenttime)
#                 cursor.execute(query, val)
#                 db.commit()
#                 cursor.close()
...
#                 cursor = db.cursor()
#                 query = "DELETE FROM active_listings_khandallah WHERE id = %s"
